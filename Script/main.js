...
const addModalSupport = (event,el) => {
	el.classList.add('modal-support-open');
};


const removeModalSupport = (event,el) => {
	el.classList.remove('modal-support-open');
};
...
support.addEventListener('click', () => {
	addModalSupport(event, modalSupport);
});
closeSupport.addEventListener('click', () => {
	removeModalSupport(event, modalSupport);
});
// форма для номера
